...
public class FileController {
    ...
    public Result<?> upload(MultipartFile file) throws IOException {
        ...
        String rootFilePath = System.getProperty("user.dir") + "/demo/src/main/resources/files/" + flag + "_" + originalFilename;//获取上传的路径
    ...
    public void getFiles(@PathVariable String flag, HttpServletResponse response){
        ...
        String basePath = System.getProperty("user.dir") + "/demo/src/main/resources/files/"; //定义文件上传的根路径
